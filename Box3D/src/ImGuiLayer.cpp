...
namespace box3d {
        ...
        : Layer("ImGuiLayer")
    {
        ...
        this->show_mainmenubar  = true;
        this->dockspace_enabled = true;
    }
    ...
    void ImGuiLayer::DockSpace(bool enable)
    {
    ...
    void ImGuiLayer::MainMenuBar(bool show)
    {
