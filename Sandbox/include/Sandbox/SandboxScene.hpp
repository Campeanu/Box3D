...
#include "TestScene/filesystem.hpp"
#include "TestScene/shader_m.hpp"
#include "TestScene/camera.hpp"
...
namespace TestScene {
    ...
    private:
        ...
        float quadVertices[501] = { // vertex attributes for a quad that fills the entire screen in Normalized Device Coordinates.
            // positions   // texCoords
            -1.0f,  1.0f,  0.0f, 1.0f,
            -1.0f, -1.0f,  0.0f, 0.0f,
             1.0f, -1.0f,  1.0f, 0.0f,
